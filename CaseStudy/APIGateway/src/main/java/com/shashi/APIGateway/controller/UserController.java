...
import com.shashi.APIGateway.config.JwtTokenUtil;
import com.shashi.APIGateway.dto.SigninRequest;
import com.shashi.APIGateway.dto.SigninResponse;
import com.shashi.APIGateway.dto.UserDto;
import com.shashi.APIGateway.exception.InvalidTokenException;
import com.shashi.APIGateway.exception.UserAlreadyExistsException;
import com.shashi.APIGateway.exception.UserNotFoundException;
import com.shashi.APIGateway.model.Mail;
import com.shashi.APIGateway.service.MailService;
...
public class UserController 
{
			...
			throws UserAlreadyExistsException
	{
		...
		if(userDto == null) {
			throw new UserAlreadyExistsException("This Username or Email already exists!!");
		}
		
		String appUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort();
		Mail mail = new Mail();
		mail.setMailFrom("saishashixyz@gmail.com");
			...
			throws InvalidTokenException
	{
		...
		return ResponseEntity.ok("Email Verification is Successfully Completed");
	}
